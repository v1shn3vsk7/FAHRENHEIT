...
<table cellspacing="10">
    <tr>
        <td style="background-color: rgb(202, 228, 238);" align="center">
            ...
            ТЭН Hajdu<br>
            <img width="150" height="150" src="img/vodogrei1.webp"><br>
            Цена: 100$<br>
        ...
        <td style="background-color: rgb(202, 228, 238);" align="center">
            ...
            <img width="150" height="150" src="img/vodogrei2.webp"><br>
            Цена: 98$<br>
            <button style="width:auto;">В корзину</button>
        ...
        <td style="background-color: rgb(202, 228, 238);" align="center">
            ...
            Hajdu ID40A E<br>
            <img width="150" height="150" src="img/vodogrei3.webp"><br>
            Цена: 98$<br>
            <button style="width:auto;">В корзину</button>
                ...
                <div class="modal-content">
                    <table align="center" width="600px" border="1" cellpadding="1">
                        <thead>
                            <tr>
                                <th rowspan="2" width="200px">
                                    <img height="150" width="150" src="img/vodogrei3.webp">
                                </th>
                                <th colspan="2" style="font-size: 25px;">
